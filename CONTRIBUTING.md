Contributing to exobot
======================

So you want to contribute to exobot? Fantastic! Here's a brief overview on
how best to do so.
...
[create an issue](https://github.com/exoplay/exobot/issues) before putting
...
1. [Fork the repository](https://github.com/exoplay/exobot/fork_select) to
  your Github account.
...
exobot is MIT licensed. See details in the LICENSE file. This is a very permissive
